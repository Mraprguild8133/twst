...
MERCHANT_UPI_ID = os.getenv("MERCHANT_UPI_ID", "test@okaxis")  # Default for testing
...
async def upload_file_handler(client, message: Message):
    ...
    try:
        ...
        try:
            ...
            await status_message.edit_text(f"✅ File uploaded but link generation failed: {str(e)}")
